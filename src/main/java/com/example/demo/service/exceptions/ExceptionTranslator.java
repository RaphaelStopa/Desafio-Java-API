...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    public ResponseEntity<Problem> process(@Nullable ResponseEntity<Problem> entity, NativeWebRequest request) {
        ...
        ProblemBuilder builder = Problem
            .builder()
            .withType(Problem.DEFAULT_TYPE.equals(problem.getType()) ? URIErrorConstants.DEFAULT_TYPE : problem.getType())
        ...
        if (problem instanceof ConstraintViolationProblem) {
            builder
                ...
                .with(MESSAGE_KEY, URIErrorConstants.ERR_VALIDATION);
        } else {
    ...
    public ResponseEntity<Problem> handleMethodArgumentNotValid(MethodArgumentNotValidException ex, @Nonnull NativeWebRequest request) {
        ...
        Problem problem = Problem
            .builder()
            .withType(URIErrorConstants.CONSTRAINT_VIOLATION_TYPE)
    ...
    public ResponseEntity<Problem> handleConcurrencyFailure(ConcurrencyFailureException ex, NativeWebRequest request) {
        Problem problem = Problem.builder().withStatus(Status.CONFLICT).with(MESSAGE_KEY, URIErrorConstants.ERR_CONCURRENCY_FAILURE).build();
        return create(ex, problem, request);
    }
    ...
    public ProblemBuilder prepare(final Throwable throwable, final StatusType status, final URI type) {
        ...
        // todo aqui tinha que ser de outra forma
